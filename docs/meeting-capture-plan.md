...
Status: implemented (all five phases). The user guide is
`docs/meeting-capture.md`, the shipped configuration is documented in
`docs/configuration.md`; this file is the design record. Target release: 0.4.0. The shipped
